...
function addslidemy(imgname, imgthumb, imgtext)
{
	...
	'<div class="del"><input name="myslidedelete' + counter + '" class="myslidedelete" type="button" value="' + Joomla.JText._('MOD_SPARTA_REMOVE', 'RemoveSlide') + '" onclick="javascript:removeslide(this.getParent().getParent());" />'+
